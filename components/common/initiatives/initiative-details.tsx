...
import { Initiative, INITIATIVE_STATUS_META } from '@/lib/domain/initiatives';
import { completedProjectCount, initiativeProjects } from '@/lib/data/initiatives';
import { InitiativeDescription, InitiativeName, InitiativeProperties } from './initiative-editable';
import { useInitiatives, useProjects } from '@/hooks/use-workspace-data';
...
function ProjectsSection({ initiative }: { initiative: Initiative }) {
   ...
   const projects = initiativeProjects(initiative, allProjects);
...
function Overview({ initiative }: { initiative: Initiative }) {
   const allProjects = useProjects();
   const completed = completedProjectCount(initiative, allProjects);
      ...
      <div className="w-full h-full flex overflow-hidden">
         <div className="flex-1 min-w-0 overflow-y-auto">
            <div className="max-w-3xl mx-auto px-8 py-10 flex flex-col gap-6">
               ...
               <InitiativeProperties initiative={initiative} />
      ...
      return [
         {
            ...
            projects: initiativeProjects(initiative, allProjects),
         },
      ];
